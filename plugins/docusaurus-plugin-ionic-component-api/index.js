    ...
    async loadContent() {
      ...
      for (const version of Object.keys(docsPluginOptions.versions)) {
        ...
        components.forEach((comp) => {
          ...
          const outDir = getDirectoryPath(compTag, versionData.path ?? version, version === 'current');

          writeAutoGeneratedPage(outDir, 'props', renderProperties(comp));
          writeAutoGeneratedPage(outDir, 'events', renderEvents(comp));
          writeAutoGeneratedPage(outDir, 'methods', renderMethods(comp));
          writeAutoGeneratedPage(outDir, 'parts', renderParts(comp));
          writeAutoGeneratedPage(outDir, 'custom-props', renderCustomProps(comp));
          writeAutoGeneratedPage(outDir, 'slots', renderSlots(comp));
        });
      }
    },
    async contentLoaded() {},
