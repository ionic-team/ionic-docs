...
<ion-grid>
  <ion-row>
    ...
    <ion-col offset-md="2">2 of 4</ion-col>
    <ion-col offset-md="2">3 of 4</ion-col>
    <ion-col offset-md="2">4 of 4</ion-col>
  </ion-row>
</ion-grid>
...
<ion-grid>
  <ion-row>
    <ion-col offset="6" offset-md="4" offset-lg="2">1 of 2</ion-col>
    <ion-col offset="6" offset-md="4" offset-lg="2">2 of 2</ion-col>
  </ion-row>
</ion-grid>
```
