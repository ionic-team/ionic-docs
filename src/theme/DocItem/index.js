...
function DocItem(props) {
  ...
  const fileName = editUrl.split('/docs/api/');

  const revisedEditUrl =
    fileName.length > 1
      ? `https://github.com/ionic-team/ionic-framework/edit/master/core/src/components/${
          fileName[1].split('.md')[0]
        }/readme.md`
      : editUrl;
      ...
      <div className={clsx('', pageCSSClass, styles.docItemWrapper)}>
        <div className={styles.docItemMain}>
          ...
          <div className={styles.docItemContainer}>
            ...
            {(revisedEditUrl || lastUpdatedAt || lastUpdatedBy) && (
