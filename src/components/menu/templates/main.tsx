...
const items = {
  ...
  "menu-developing": {
    ...
    "menu-developing-hardware-back-button":
      "/docs/developing/hardware-back-button",
  ...
  "menu-angular": {
    ...
    "": {
      "menu-angular-yfa-taking-photos":
        "/docs/angular/your-first-app/2-taking-photos",
      "menu-angular-yfa-saving-photos":
        "/docs/angular/your-first-app/3-saving-photos",
      "menu-angular-yfa-loading-photos":
        "/docs/angular/your-first-app/4-loading-photos",
      "menu-angular-yfa-adding-mobile":
        "/docs/angular/your-first-app/5-adding-mobile",
      "menu-angular-yfa-deploying-mobile":
        "/docs/angular/your-first-app/6-deploying-mobile",
      "menu-angular-yfa-live-reload":
        "/docs/angular/your-first-app/7-live-reload",
    },
  ...
  "menu-react": {
    ...
    "": {
      "menu-react-yfa-taking-photos":
        "/docs/react/your-first-app/2-taking-photos",
      "menu-react-yfa-saving-photos":
        "/docs/react/your-first-app/3-saving-photos",
      "menu-react-yfa-loading-photos":
        "/docs/react/your-first-app/4-loading-photos",
      "menu-react-yfa-adding-mobile":
        "/docs/react/your-first-app/5-adding-mobile",
      "menu-react-yfa-deploying-mobile":
        "/docs/react/your-first-app/6-deploying-mobile",
  ...
  "menu-deployment": {
    ...
    "menu-deployment-progressive-web-app":
      "/docs/deployment/progressive-web-app",
  ...
  "menu-core-concepts": {
    ...
    "menu-core-concepts-what-are-progressive-web-apps":
      "/docs/core-concepts/what-are-progressive-web-apps",
  },
  "menu-contributing": {
    "menu-contributing-how-to-contribute":
