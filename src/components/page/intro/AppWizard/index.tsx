...
export default function AppWizard(props) {
  return <div {...props} className={clsx(props.className, 'app-wizard', styles.appWizard)}>
    ...
    <div>
      <a href="https://ionicframework.com/start" className="wizard-button">Open Wizard <ion-icon name="arrow-forward-outline"/></a>
    </div>
  </div>
}