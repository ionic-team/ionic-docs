  ...
  return (
    <section>
      ...
      <docs-card class="cordova-ee-card" header="Don't waste precious time on plugin issues." href="https://ionicframework.com/sales?product_of_interest=Ionic%20Enterprise%20Engine">
        <img key="0" src="/docs/assets/icons/native-cordova-bot.png" class="cordova-ee-img" />
        <p key="1">If you're building a serious project, you can't afford to spend hours troubleshooting. Ionic's experts offer official maintenance, support, and integration help.</p>
        <docs-button key="2" class="native-ee-detail" href="https://ionicframework.com/sales?product_of_interest=Ionic%20Enterprise%20Engine">Contact Us Today!</docs-button>
      </docs-card>
    </section>
  );
};
