...
![Xcode Custom iOS Target Properties](xcode-info-plist.png)
...
![Xcode - Selecting Development Team](xcode-signing.png)
...
![Xcode build button](xcode-build-button.png)
...
![iOS Camera permissions](ios-permissions-photo.png)
...
![Android Manifest location](android-manifest.png)
