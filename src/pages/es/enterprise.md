...
Ionic Native includes a reliable set of Native APIs & functionality that you can use in your Ionic app, quality controlled and maintained by the Ionic Team.
...
In order to use the Ionic Native plugins you need to install the Ionic Enterprise Cordova CLI. Ionic Native plugins use scoped packages and the regular Cordova CLI does not work with scoped packages.
...
In order to use the Ionic Native plugins in your application you will need to register your key with the application. Each application that you create will need to have its own key.
