...
| ------------------------ | ------------------ | ------------------------------------------------------------------------------------------------------------------------------------- |
| `actionSheetEnter`       | `AnimationBuilder` | Proporciona una animación de entrada personalizada para todos los `ion-action-sheet`, sobreescribiendo la "animación" predeterminada. |
