...
class Picker {
    ...
    static get properties() { return { "addButton": { "method": true }, "addColumn": { "method": true }, "animationCtrl": { "connect": "ion-animation-controller" }, "buttons": { "type": "Any", "attr": "buttons" }, "columns": { "type": "Any", "attr": "columns" }, "config": { "context": "config" }, "cssClass": { "type": String, "attr": "css-class" }, "dismiss": { "method": true }, "dom": { "context": "dom" }, "duration": { "type": Number, "attr": "duration" }, "el": { "elementRef": true }, "enableBackdropDismiss": { "type": Boolean, "attr": "enable-backdrop-dismiss" }, "enterAnimation": { "type": "Any", "attr": "enter-animation" }, "getColumn": { "method": true }, "getColumns": { "method": true }, "leaveAnimation": { "type": "Any", "attr": "leave-animation" }, "present": { "method": true }, "showBackdrop": { "type": Boolean, "attr": "show-backdrop" }, "showSpinner": { "state": true }, "spinner": { "state": true }, "willAnimate": { "type": Boolean, "attr": "will-animate" } }; }
