...
export { domControllerAsync, isDef, playAnimationAsync, getOrAppendElement, getPageElement, assert, normalizeUrl, focusOutActiveElement, isNumber, isParentTab, isString, now, deferEvent, isArray, isBlank, clamp, isObject, updateDetail, debounceEvent, isRightSide, swipeShouldReset, getDocument, getWindow, hasFocusedTextInput, checkEdgeSide, pointerCoordX, pointerCoordY, asyncRaf, getIonApp, getNavAsChildIfExists };
