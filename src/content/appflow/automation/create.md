...
<img src="/docs/assets/img/appflow/ss-automation-create-type.png" class="browser" />
...
<img src="/docs/assets/img/appflow/ss-automation-create-package.png" class="browser" />

#### Fields

* **Environment:** The [custom build environment](/docs/appflow/builds/environments#custom-environments) (if any) to use when this automations is triggered.
...
* **Security Profile:** Which security profile to use. Learn more about them [here](/docs/appflow/package/profiles.html).
...
<img src="/docs/assets/img/appflow/ss-automation-create-web.png" class="browser" />
