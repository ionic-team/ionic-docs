...
The default amount of `padding` to be applied is `16px` and is set by the `--ion-padding` variable. See the [CSS Variables](/docs/guide/theming/css-variables.md) section for more information on how to change these values.
...
The default amount of `margin` to be applied is `16px` and is set by the `--ion-margin` variable. See the [CSS Variables](/docs/guide/theming/css-variables.md) section for more information on how to change these values.
