...
## モバイルプラットフォーム {/* #mobile-platforms */}

[スタイルの適用](../core-concepts/fundamentals.mdx#adaptive-styling)を追求するために, Ionic は以下のモバイルプラットフォームを完全にサポート、テストしています。:
...
### Android Support の注意点 {/* #a-note-on-android-support */}
