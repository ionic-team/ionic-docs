...
## Manual Focus Management {/* #manual-focus-management */}
...
### Why not autofocus? {/* #why-not-autofocus */}
...
## Assistive Technology Focus Management {/* #assistive-technology-focus-management */}
...
### Specifying Priority {/* #specifying-priority */}
