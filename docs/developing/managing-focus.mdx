...
## 手動フォーカス管理 {/* #manual-focus-management */}
...
### なぜ autofocus を使わないのか？ {/* #why-not-autofocus */}
...
### プラットフォームの制限 {/* #platform-restrictions */}
...
## アシスティブテクノロジーのフォーカス管理 {/* #assistive-technology-focus-management */}
...
### 実装に関する注意事項 {/* #implementation-notes */}
