...
許可されている値の一覧については、[inputmode ドキュメント](https://developer.mozilla.org/en-US/docs/Web/HTML/Global_attributes/inputmode)を参照してください。
...
許可されている値の一覧については、[enterkeyhint 標準](https://html.spec.whatwg.org/dev/interaction.html#input-modalities:-the-enterkeyhint-attribute)を参照してください。
...
Capacitor や Cordova でアプリを実行する際、特定のテーマでキーボードを表示することが可能です。この設定に関する詳細は、[Capacitor Keyboard Documentation](https://capacitorjs.com/docs/apis/keyboard#keyboard-configuration-ios-only-)を参照してください。

## アクセサリバーを非表示にする {/* #hiding-the-accessory-bar */}
...
Capacitor や Cordova でアプリを実行する際、アクセサリーバーを非表示にすることが可能です。この設定に関する詳細は、[Capacitor Keyboard Documentation](https://capacitorjs.com/docs/apis/keyboard#keyboard-configuration-ios-only-)を参照してください。
