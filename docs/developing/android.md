...
The Developing for Android guide has officially migrated to the Capacitor docs: https://capacitorjs.com/docs/android. Looking for the legacy docs? [Click here](/docs/v6/developing/android).
