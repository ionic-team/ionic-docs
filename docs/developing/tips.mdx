...
<small>_Windowsでは利用できません_</small>
...
## 依存モジュールの更新 {/* #updating-dependencies */}
...
## iOS シミュレータを使用する {/* #using-the-ios-simulator */}
...
## Genymotion Android エミュレーターを使用する {/* #using-the-genymotion-android-emulator */}
