...
## Per-Component Config {/* #per-component-config */}
...
## Per-Platform Config {/* #per-platform-config */}
...
## Accessing the Mode {/* #accessing-the-mode */}
...
## Reading the Config (Angular) {/* #reading-the-config-angular */}
...
| `platform`                  | [`PlatformConfig`](/angular/platform.mdx#customizing-platform-detection-functions) | Overrides the default platform detection methods.                                                                                                                                                                                                                                      |
