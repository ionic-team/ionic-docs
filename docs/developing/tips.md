...
![Screenshot of a browser's device toolbar with 'iPhone X' selected, showing dimensions and battery status.](/img/faq/tips/change-device-platform.png "Changing Device Platform in Browser")
