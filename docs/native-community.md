...
description: 'For the Cordova user community, Awesome Cordova Plugins maintains a collection of TypeScript wrappers for open source Cordova core plugins easily add native functionality to any Ionic app.'
sidebar_label: Setup
...
For developers using Ionic with Cordova, we suggest using a community project called [Awesome Cordova Plugins](https://github.com/danielsogl/awesome-cordova-plugins) a collection of TypeScript wrappers for open source Cordova plugins that make it easy to add native functionality to any Ionic app.
...
React apps must use Capacitor to build native mobile apps. However, Awesome Cordova Plugins can still be used.
