...
Ionic CLI は、[TypeScript](/docs/reference/glossary#typescript)と [Node.js](/docs/reference/glossary#node)で構築されています。Node 10.3+をサポートしていますが、最新の Node LTS が推奨です。開発状況は、オープンソースの [GitHub リポジトリ](https://github.com/ionic-team/ionic-cli)で確認できます。
