    ...
    <div className={clsx(props.className, styles.nativeEnterpriseCards)}>
      <a href="https://capacitorjs.com/docs/plugins">
        <div className="image-wrapper">
          <img src={require('../_assets/img/capacitor@2x.png').default} width="440" height="222" alt="capacitor logo"/>
        </div>
      ...
      <a href="native/community">
        <div className="image-wrapper">
          <img src={require('../_assets/img/cordova@2x.png').default}width="440" height="222" alt="cordova logo"/>
        </div>
        <div className="heading-group">
...
export function NativeEnterprise(props) {
  return (
    <a className={clsx(props.className, styles.nativeEnterprise)} href="https://ionicframework.com/native">
      <div className="image-wrapper">
        <img src={require('../_assets/img/native-enterprise@2x.png').default} width="476" height="228" />
      </div>
