...
<DocsCard
  ...
  icon={require('./react/_assets/img/logo-react-icon.png').default}
>
...
<DocsCard
  header="Navigation"
  href="react/navigation"
  icon={require('./react/_assets/img/feature-component-navigation-icon.png').default}
>
...
<DocsCard
  ...
  icon={require('./react/_assets/img/feature-guide-components-icon.png').default}
>
