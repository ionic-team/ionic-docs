...
## Vue バージョンサポート {/* #vue-version-support */}

Ionic Vue v9 は Vue 3.5 以降をサポートしています。サポートされているバージョンやサポートポリシーの詳細については、[Ionic Vue サポートポリシー](/reference/support.mdx#ionic-vue)を参照してください。
