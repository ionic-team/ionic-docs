...
:::note
フルモジュール一覧は [Swiper の Vue 使用方法のドキュメント](https://swiperjs.com/vue#usage) を参照してください。
:::
...
:::note
Swiper Vue で使用可能なすべてのプロパティは [Swiper Vue プロパティのドキュメント](https://swiperjs.com/vue#swiper-props) に記載されています。
:::
...
:::note
Swiper Vue で使用可能なすべてのイベントは [Swiper Vue イベントのドキュメント](https://swiperjs.com/vue#swiper-events) に記載されています。
:::
...
:::note
Swiper のエフェクトに関する詳細は [Swiper Vue エフェクトのドキュメント](https://swiperjs.com/vue#effects) を参照してください。
:::
...
問題を報告する前に、コミュニティによって問題が解決できるかを確認するために、[Swiper Discussion Board](https://github.com/nolimits4web/swiper/discussions)または[Ionic Forum](https://forum.ionicframework.com)に投稿を作成することを検討してください。

Swiper ライブラリで問題が発生している場合、新しいバグは[Swiper のイシュートラッカー](https://github.com/nolimits4web/swiper/issues)に報告する必要があります。

`IonicSlides`モジュールで問題が発生している場合、新しいバグは[Ionic Framework のイシュートラッカー](https://github.com/ionic-team/ionic-framework/issues)に報告する必要があります。
