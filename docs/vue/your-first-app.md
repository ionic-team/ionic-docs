...
The cool things we can do with Ionic don't end there. The next step is to include camera capabilities on the web, after which iOS and Android versions will be developed.
