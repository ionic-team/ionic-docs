...
## 異なる Routes へのナビゲーション {/* #navigating-to-different-routes */}
...
### どちらを選ぶべきか {/* #which-one-should-i-choose */}
...
### どちらを選ぶべきか {/* #which-one-should-i-choose-1 */}
...
### タブ内の子ルート {/* #how-tabs-in-ionic-work */}
