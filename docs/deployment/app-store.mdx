...
## リリースビルドの作成 {/* #generating-a-release-build */}
...
## 署名証明書の生成 {/* #generating-signing-certs */}
...
## XCode でのアプリへの署名 {/* #signing-the-app-in-xcode */}
...
## アプリのアップデート {/* #updating-an-app */}

アプリが成長するにつれ、新機能や修正を加えて更新する必要があります。
アプリのアップデートは、Apple に新バージョンを提出するか、Appflow のような[live update 機能](https://ionic.io/docs/appflow/deploy/intro)を使用することで可能です。
