...
:::note
In order for the Google Play Store to accept updated AAB/APK, the `android/app/bundle.gradle` file will need to be edited to increment the `versionName` value, then rebuild the app for release following the instructions above.
:::
