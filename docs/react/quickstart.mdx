...
Navigating can also be performed programmatically using the `useIonRouter` hook. See the [React Navigation documentation](/react/utility-functions.mdx#useionrouter) for more information.
