...
:::note
モジュールの完全なリストについては、[Swiper の React 使用ドキュメント](https://swiperjs.com/react#usage)を参照してください。
:::
...
:::note
Swiper React で使用可能なすべてのプロパティは、[Swiper React の props ドキュメント](https://swiperjs.com/react#swiper-props)で確認できます。
:::
...
:::note
Swiper で使用可能なすべてのイベントは、[Swiper API のイベントドキュメント](https://swiperjs.com/swiper-api#events)で確認できます。
:::
...
:::note
Swiper のエフェクトに関する詳細については、[Swiper React のエフェクトドキュメント](https://swiperjs.com/react#effects)を参照してください。
:::
...
問題を提出する前に、まず[Swiper Discussion Board](https://github.com/nolimits4web/swiper/discussions)または[Ionic Forum](https://forum.ionicframework.com)に投稿して、コミュニティで問題が解決できるか確認することを検討してください。

Swiper ライブラリに問題が発生している場合、新しいバグは[Swiper のイシュートラッカー](https://github.com/nolimits4web/swiper/issues)に報告してください。

`IonicSlides`モジュールに問題が発生している場合、新しいバグは[Ionic Framework のイシュートラッカー](https://github.com/ionic-team/ionic-framework/issues)に報告してください。
