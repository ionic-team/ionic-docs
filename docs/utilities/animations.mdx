...
## キーフレームアニメーション {/* #keyframe-animations */}
...
## グループ化されたアニメーション {/* #grouped-animations */}
...
## Before/After フック {/* #before-and-after-hooks */}
...
## チェーンされたアニメーション {/* #chained-animations */}
...
Ionic Animations は、[Ionic Gestures](gestures.mdx)とシームレスに統合することで、強力なジェスチャーベースのアニメーションを作成する機能を開発者に提供します。
...
## ユーザー設定ベースのアニメーション {/* #preference-based-animations */}
...
## Ionic コンポーネントアニメーションのオーバーライド {/* #overriding-ionic-component-animations */}
