...
## ダブルクリックジェスチャー {/* #double-click-gesture */}
...
ジェスチャーアニメーションの実装ガイドについては、[Ionic Animations を使用したジェスチャーアニメーション](animations.mdx#gesture-animations)を参照してください。
