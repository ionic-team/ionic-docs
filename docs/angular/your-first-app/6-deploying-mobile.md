...
![iOS device screen showing the camera permission prompt and a photo taken with the app.](/img/guides/first-app-cap-ng/ios-permissions-photo.png "iOS Permissions and Photo Capture")
...
![Android Studio editor showing the AndroidManifest.xml file with camera permissions.](/img/guides/first-app-cap-ng/android-manifest.png "Android Manifest Configuration")
...
![Android device screen displaying the camera permission prompt and a photo taken with the app.](/img/guides/first-app-cap-ng/android-permissions-photo.png "Android Permissions and Photo Capture")
