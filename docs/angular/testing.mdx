...
#### `jasmine.createSpy` と `jasmine.createSpyObj` の利用 {/* #using-jasminecreatespy-and-jasminecreatespyobj */}
...
#### `spyOn()` と `spyOnProperty()` の利用 {/* #using-spyon-and-spyonproperty */}
...
### 一般的なテストの構成 {/* #general-testing-structure */}
...
### ページとコンポーネント {/* #pages-and-components */}
...
### コンポーネントの待機 {/* #waiting-for-components */}
...
### 基本的な Service のテスト {/* #basic-service-testing */}
...
#### HTTP データ Service のテスト {/* #testing-http-data-services */}
...
##### `environment.e2e.ts` ファイルを生成 {/* #create-the-environmente2ets-file */}
...
##### `angular.json` ファイルを修正 {/* #modify-the-angularjson-file */}
...
##### `package.json` ファイルを修正 {/* #modify-the-packagejson-file */}
