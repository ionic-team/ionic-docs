...
title: "ion-menu"
---
import Props from '@ionic-internal/component-api/v10/menu/props.md';
import Events from '@ionic-internal/component-api/v10/menu/events.md';
import Methods from '@ionic-internal/component-api/v10/menu/methods.md';
import Parts from '@ionic-internal/component-api/v10/menu/parts.md';
import CustomProps from '@ionic-internal/component-api/v10/menu/custom-props.mdx';
import Slots from '@ionic-internal/component-api/v10/menu/slots.md';
...
import Basic from '@site/static/usage/v10/menu/basic/index.md';
...
import MenuToggle from '@site/static/usage/v10/menu/toggle/index.md';
...
import MenuType from '@site/static/usage/v10/menu/type/index.md';
...
import Sides from '@site/static/usage/v10/menu/sides/index.md';
...
import Multiple from '@site/static/usage/v10/menu/multiple/index.md';
...
import Theming from '@site/static/usage/v10/menu/theming/index.md';
