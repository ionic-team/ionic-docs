...
## Pull Properties {/* #pull-properties */}
...
## Custom Refresher Content {/* #custom-refresher-content */}
...
## Native Refreshers {/* #native-refreshers */}
...
### Using `ionPullStart` and `ionPullEnd` {/* #using-ionpullstart-and-ionpullend */}
...
### RefresherPullEndEventDetail {/* #refresherpullendeventdetail */}
...
### RefresherPullEndCustomEvent {/* #refresherpullendcustomevent */}
