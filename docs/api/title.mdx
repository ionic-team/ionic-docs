...
## Collapsible Large Titles {/* #collapsible-large-titles */}
...
The [buttons](./buttons.mdx) component can be used with the [`collapse`](./buttons.mdx#prop-collapse) property to additionally display in the header as the toolbar is collapsed.
