...
import Props from '@ionic-internal/component-api/v10/action-sheet/props.mdx';
import Events from '@ionic-internal/component-api/v10/action-sheet/events.mdx';
import Methods from '@ionic-internal/component-api/v10/action-sheet/methods.mdx';
import Parts from '@ionic-internal/component-api/v10/action-sheet/parts.mdx';
import CustomProps from '@ionic-internal/component-api/v10/action-sheet/custom-props.mdx';
import Slots from '@ionic-internal/component-api/v10/action-sheet/slots.mdx';
...
import Trigger from '@site/static/usage/v10/action-sheet/inline/trigger/index.mdx';
...
import IsOpen from '@site/static/usage/v10/action-sheet/inline/isOpen/index.mdx';
...
import Controller from '@site/static/usage/v10/action-sheet/controller/index.mdx';
...
import RoleInfo from '@site/static/usage/v10/action-sheet/role-info-on-dismiss/index.mdx';
...
import Styling from '@site/static/usage/v10/action-sheet/theming/styling/index.mdx';
...
import CssCustomProperties from '@site/static/usage/v10/action-sheet/theming/css-properties/index.mdx';
