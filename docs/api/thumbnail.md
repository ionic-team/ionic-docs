...
import Props from '@ionic-internal/component-api/v10/thumbnail/props.md';
import Events from '@ionic-internal/component-api/v10/thumbnail/events.md';
import Methods from '@ionic-internal/component-api/v10/thumbnail/methods.md';
import Parts from '@ionic-internal/component-api/v10/thumbnail/parts.md';
import CustomProps from '@ionic-internal/component-api/v10/thumbnail/custom-props.mdx';
import Slots from '@ionic-internal/component-api/v10/thumbnail/slots.md';
...
import Basic from '@site/static/usage/v10/thumbnail/basic/index.md';

<Basic />

## Item Thumbnails

import Item from '@site/static/usage/v10/thumbnail/item/index.md';
...
import CSSProps from '@site/static/usage/v10/thumbnail/theming/css-properties/index.md';
