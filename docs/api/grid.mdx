...
### コンテンツベースサイズ {/* #content-based-size */}
...
## 列のオフセット {/* #column-offset */}

カラムは、全カラム数のうち一定のカラム数だけ右にずらすオフセットが可能です。

### 指定されたオフセット {/* #specified-offset */}
...
## コラム プッシュ＆プル {/* #column-push--pull */}

カラムの総数のうち、一定のカラム数だけ、カラムを右に押したり、左に引いたりすることができます。

### 指定されたプッシュ＆プル {/* #specified-push--pull */}
...
### プッシュ＆プルのレスポンシブ対応 {/* #responsive-push--pull */}
...
### 垂直方向のアライメント {/* #vertical-alignment */}
