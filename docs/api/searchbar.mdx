...
import Props from '@ionic-internal/component-api/v10/searchbar/props.mdx';
import Events from '@ionic-internal/component-api/v10/searchbar/events.mdx';
import Methods from '@ionic-internal/component-api/v10/searchbar/methods.mdx';
import Parts from '@ionic-internal/component-api/v10/searchbar/parts.mdx';
import CustomProps from '@ionic-internal/component-api/v10/searchbar/custom-props.mdx';
import Slots from '@ionic-internal/component-api/v10/searchbar/slots.mdx';
...
import Basic from '@site/static/usage/v10/searchbar/basic/index.mdx';
...
import SearchIcon from '@site/static/usage/v10/searchbar/search-icon/index.mdx';
...
import ClearButton from '@site/static/usage/v10/searchbar/clear-button/index.mdx';
...
import CancelButton from '@site/static/usage/v10/searchbar/cancel-button/index.mdx';
...
import Toolbar from '@site/static/usage/v10/toolbar/searchbars/index.mdx';
...
import Debounce from '@site/static/usage/v10/searchbar/debounce/index.mdx';
...
import Colors from '@site/static/usage/v10/searchbar/theming/colors/index.mdx';
...
import CSSProps from '@site/static/usage/v10/searchbar/theming/css-properties/index.mdx';
