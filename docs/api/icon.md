...
import Basic from '@site/static/usage/v10/icon/basic/index.md';
...
import FontIcons from '@site/static/usage/v10/icon/font-icons/index.md';
...
import CustomSVGs from '@site/static/usage/v10/icon/custom-svgs/index.md';
