...
title: "ion-loading"
---
import Props from '@ionic-internal/component-api/v10/loading/props.md';
import Events from '@ionic-internal/component-api/v10/loading/events.md';
import Methods from '@ionic-internal/component-api/v10/loading/methods.md';
import Parts from '@ionic-internal/component-api/v10/loading/parts.md';
import CustomProps from '@ionic-internal/component-api/v10/loading/custom-props.mdx';
import Slots from '@ionic-internal/component-api/v10/loading/slots.md';
...
import Inline from '@site/static/usage/v10/loading/inline/index.md';

<Inline />

### Controller

import Controller from '@site/static/usage/v10/loading/controller/index.md';
...
import Spinners from '@site/static/usage/v10/loading/spinners/index.md';
...
import Theming from '@site/static/usage/v10/loading/theming/index.md';
