...
## Toggling Reorder {/* #toggling-reorder */}
...
## Custom Reorder Icon {/* #custom-reorder-icon */}
...
## Reorder Wrapper {/* #reorder-wrapper */}
...
### Using `ionReorderStart` and `ionReorderEnd` {/* #using-ionreorderstart-and-ionreorderend */}
...
### Using `ionReorderMove` {/* #using-ionreordermove */}
