...
import Props from '@ionic-internal/component-api/v10/toast/props.md';
import Events from '@ionic-internal/component-api/v10/toast/events.md';
import Methods from '@ionic-internal/component-api/v10/toast/methods.md';
import Parts from '@ionic-internal/component-api/v10/toast/parts.md';
import CustomProps from '@ionic-internal/component-api/v10/toast/custom-props.mdx';
import Slots from '@ionic-internal/component-api/v10/toast/slots.md';
...
import InlineToastTriggerExample from '@site/static/usage/v10/toast/inline/basic/index.md';
...
import InlineToastIsOpenExample from '@site/static/usage/v10/toast/inline/is-open/index.md';

<InlineToastIsOpenExample />

## Controller Toasts

import ControllerExample from '@site/static/usage/v10/toast/presenting/controller/index.md';
...
import ButtonsPlayground from '@site/static/usage/v10/toast/buttons/index.md';
...
import PositionAnchor from '@site/static/usage/v10/toast/position-anchor/index.md';
...
import SwipeGesture from '@site/static/usage/v10/toast/swipe-gesture/index.md';
...
import StackedPlayground from '@site/static/usage/v10/toast/layout/index.md';
...
import IconPlayground from '@site/static/usage/v10/toast/icon/index.md';

<IconPlayground />

## Theming

import ThemingPlayground from '@site/static/usage/v10/toast/theming/index.md';
