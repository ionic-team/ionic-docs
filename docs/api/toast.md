...
import Props from '@ionic-internal/component-api/v10/toast/props.mdx';
import Events from '@ionic-internal/component-api/v10/toast/events.mdx';
import Methods from '@ionic-internal/component-api/v10/toast/methods.mdx';
import Parts from '@ionic-internal/component-api/v10/toast/parts.mdx';
import CustomProps from '@ionic-internal/component-api/v10/toast/custom-props.mdx';
import Slots from '@ionic-internal/component-api/v10/toast/slots.mdx';
...
import InlineToastTriggerExample from '@site/static/usage/v10/toast/inline/basic/index.mdx';
...
import InlineToastIsOpenExample from '@site/static/usage/v10/toast/inline/is-open/index.mdx';

<InlineToastIsOpenExample />

## Controller Toasts

import ControllerExample from '@site/static/usage/v10/toast/presenting/controller/index.mdx';
...
import ButtonsPlayground from '@site/static/usage/v10/toast/buttons/index.mdx';
...
import PositionAnchor from '@site/static/usage/v10/toast/position-anchor/index.mdx';
...
import SwipeGesture from '@site/static/usage/v10/toast/swipe-gesture/index.mdx';
...
import StackedPlayground from '@site/static/usage/v10/toast/layout/index.mdx';
...
import IconPlayground from '@site/static/usage/v10/toast/icon/index.mdx';

<IconPlayground />

## Theming

import ThemingPlayground from '@site/static/usage/v10/toast/theming/index.mdx';
