...
title: "ion-searchbar"
---
import Props from '@ionic-internal/component-api/v10/searchbar/props.md';
import Events from '@ionic-internal/component-api/v10/searchbar/events.md';
import Methods from '@ionic-internal/component-api/v10/searchbar/methods.md';
import Parts from '@ionic-internal/component-api/v10/searchbar/parts.md';
import CustomProps from '@ionic-internal/component-api/v10/searchbar/custom-props.mdx';
import Slots from '@ionic-internal/component-api/v10/searchbar/slots.md';
...
import Basic from '@site/static/usage/v10/searchbar/basic/index.md';
...
import SearchIcon from '@site/static/usage/v10/searchbar/search-icon/index.md';
...
import ClearButton from '@site/static/usage/v10/searchbar/clear-button/index.md';
...
import CancelButton from '@site/static/usage/v10/searchbar/cancel-button/index.md';
...
import Toolbar from '@site/static/usage/v10/toolbar/searchbars/index.md';
...
import Debounce from '@site/static/usage/v10/searchbar/debounce/index.md';
...
import Colors from '@site/static/usage/v10/searchbar/theming/colors/index.md';
...
import CSSProps from '@site/static/usage/v10/searchbar/theming/css-properties/index.md';
