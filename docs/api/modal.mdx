...
## インラインモーダル(推奨) {/* #inline-modals-recommended */}
...
## モーダルの終了を防止する {/* #preventing-a-modal-from-dismissing */}
...
### boolean値の設定 {/* #setting-a-boolean-value */}
...
### コールバック関数を設定する {/* #setting-a-callback-function */}
...
### スワイプで閉じないようにする {/* #prevent-swipe-to-close */}
...
### 子コンポーネントでのdismiss動作の変更 {/* #modifying-dismiss-behavior-in-child-components */}
...
### 背景コンテンツとのインタラクション {/* #interacting-with-background-content */}
...
### インナー コンテンツのマウント {/* #mounting-inner-contents */}
