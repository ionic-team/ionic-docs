...
import Props from '@ionic-internal/component-api/v10/item/props.mdx';
import Events from '@ionic-internal/component-api/v10/item/events.mdx';
import Methods from '@ionic-internal/component-api/v10/item/methods.mdx';
import Parts from '@ionic-internal/component-api/v10/item/parts.mdx';
import CustomProps from '@ionic-internal/component-api/v10/item/custom-props.mdx';
import Slots from '@ionic-internal/component-api/v10/item/slots.mdx';
...
import Basic from '@site/static/usage/v10/item/basic/index.mdx';
...
import SupportingVisuals from '@site/static/usage/v10/item/content-types/supporting-visuals/index.mdx';
...
import Text from '@site/static/usage/v10/item/content-types/text/index.mdx';
...
import Metadata from '@site/static/usage/v10/item/content-types/metadata/index.mdx';
...
import Actions from '@site/static/usage/v10/item/content-types/actions/index.mdx';
...
import Controls from '@site/static/usage/v10/item/content-types/controls/index.mdx';
...
import Clickable from '@site/static/usage/v10/item/clickable/index.mdx';
...
import DetailArrows from '@site/static/usage/v10/item/detail-arrows/index.mdx';
...
import Lines from '@site/static/usage/v10/item/lines/index.mdx';
...
import Buttons from '@site/static/usage/v10/item/buttons/index.mdx';
