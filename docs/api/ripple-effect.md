...
import Props from '@ionic-internal/component-api/v10/ripple-effect/props.mdx';
import Events from '@ionic-internal/component-api/v10/ripple-effect/events.mdx';
import Methods from '@ionic-internal/component-api/v10/ripple-effect/methods.mdx';
import Parts from '@ionic-internal/component-api/v10/ripple-effect/parts.mdx';
import CustomProps from '@ionic-internal/component-api/v10/ripple-effect/custom-props.mdx';
import Slots from '@ionic-internal/component-api/v10/ripple-effect/slots.mdx';
...
import Basic from '@site/static/usage/v10/ripple-effect/basic/index.mdx';
...
import Type from '@site/static/usage/v10/ripple-effect/type/index.mdx';
...
import Customizing from '@site/static/usage/v10/ripple-effect/customizing/index.mdx';
