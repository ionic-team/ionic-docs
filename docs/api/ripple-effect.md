...
---
import Props from '@ionic-internal/component-api/v10/ripple-effect/props.md';
import Events from '@ionic-internal/component-api/v10/ripple-effect/events.md';
import Methods from '@ionic-internal/component-api/v10/ripple-effect/methods.md';
import Parts from '@ionic-internal/component-api/v10/ripple-effect/parts.md';
import CustomProps from '@ionic-internal/component-api/v10/ripple-effect/custom-props.mdx';
import Slots from '@ionic-internal/component-api/v10/ripple-effect/slots.md';
...
import Basic from '@site/static/usage/v10/ripple-effect/basic/index.md';
...
import Type from '@site/static/usage/v10/ripple-effect/type/index.md';
...
import Customizing from '@site/static/usage/v10/ripple-effect/customizing/index.md';
