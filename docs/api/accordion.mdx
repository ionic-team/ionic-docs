...
## アコーディオンをトグルする方法 {/* #toggle-accordions */}
...
## アコーディオンの状態変化を監視 {/* #listen-for-accordion-state-changes */}
...
## 複数のアコーディオン {/* #multiple-accordions */}
...
## アコーディオンの無効化 {/* #disabling-accordions */}

### アコーディオンを無効にする {/* #individual-accordion */}
...
## 読み込み可能なアコーディオン {/* #readonly-accordions */}

### アコーディオンを無効にする {/* #individual-accordion-1 */}
...
### 高度な拡張スタイル {/* #advanced-expansion-styles */}
