...
title: "ion-row"
---
import Props from '@ionic-internal/component-api/v10/row/props.md';
import Events from '@ionic-internal/component-api/v10/row/events.md';
import Methods from '@ionic-internal/component-api/v10/row/methods.md';
import Parts from '@ionic-internal/component-api/v10/row/parts.md';
import CustomProps from '@ionic-internal/component-api/v10/row/custom-props.mdx';
import Slots from '@ionic-internal/component-api/v10/row/slots.md';
