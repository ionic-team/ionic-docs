...
title: "ion-toolbar"
---
import Props from '@ionic-internal/component-api/v10/toolbar/props.md';
import Events from '@ionic-internal/component-api/v10/toolbar/events.md';
import Methods from '@ionic-internal/component-api/v10/toolbar/methods.md';
import Parts from '@ionic-internal/component-api/v10/toolbar/parts.md';
import CustomProps from '@ionic-internal/component-api/v10/toolbar/custom-props.mdx';
import Slots from '@ionic-internal/component-api/v10/toolbar/slots.md';
...
import Basic from '@site/static/usage/v10/toolbar/basic/index.md';
...
import Buttons from '@site/static/usage/v10/toolbar/buttons/index.md';
...
import Searchbars from '@site/static/usage/v10/toolbar/searchbars/index.md';
...
import Segments from '@site/static/usage/v10/toolbar/segments/index.md';
...
import ProgressBars from '@site/static/usage/v10/toolbar/progress-bars/index.md';
...
import Colors from '@site/static/usage/v10/toolbar/theming/colors/index.md';

<Colors />

### CSS Custom Properties

import CSSProps from '@site/static/usage/v10/toolbar/theming/css-properties/index.md';
