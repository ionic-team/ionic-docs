...
---
import Props from '@ionic-internal/component-api/v10/segment-button/props.md';
import Events from '@ionic-internal/component-api/v10/segment-button/events.md';
import Methods from '@ionic-internal/component-api/v10/segment-button/methods.md';
import Parts from '@ionic-internal/component-api/v10/segment-button/parts.md';
import CustomProps from '@ionic-internal/component-api/v10/segment-button/custom-props.mdx';
import Slots from '@ionic-internal/component-api/v10/segment-button/slots.md';
...
import Basic from '@site/static/usage/v10/segment-button/basic/index.md';
...
import Layout from '@site/static/usage/v10/segment-button/layout/index.md';
...
import CSSParts from '@site/static/usage/v10/segment-button/theming/css-shadow-parts/index.md';
...
import CSSProps from '@site/static/usage/v10/segment-button/theming/css-properties/index.md';
