...
title: "ion-header"
---
import Props from '@ionic-internal/component-api/v10/header/props.md';
import Events from '@ionic-internal/component-api/v10/header/events.md';
import Methods from '@ionic-internal/component-api/v10/header/methods.md';
import Parts from '@ionic-internal/component-api/v10/header/parts.md';
import CustomProps from '@ionic-internal/component-api/v10/header/custom-props.mdx';
import Slots from '@ionic-internal/component-api/v10/header/slots.md';
...
import Basic from '@site/static/usage/v10/header/basic/index.md';
...
import Translucent from '@site/static/usage/v10/header/translucent/index.md';
...
import Condense from '@site/static/usage/v10/header/condense/index.md';
...
import Fade from '@site/static/usage/v10/header/fade/index.md';
...
import CustomScrollTarget from '@site/static/usage/v10/header/custom-scroll-target/index.md';
...
import NoBorder from '@site/static/usage/v10/header/no-border/index.md';
