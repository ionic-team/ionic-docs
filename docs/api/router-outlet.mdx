...
import Props from '@ionic-internal/component-api/v10/router-outlet/props.mdx';
import Events from '@ionic-internal/component-api/v10/router-outlet/events.mdx';
import Methods from '@ionic-internal/component-api/v10/router-outlet/methods.mdx';
import Parts from '@ionic-internal/component-api/v10/router-outlet/parts.mdx';
import CustomProps from '@ionic-internal/component-api/v10/router-outlet/custom-props.mdx';
import Slots from '@ionic-internal/component-api/v10/router-outlet/slots.mdx';
