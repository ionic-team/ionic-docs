...
import Props from '@ionic-internal/component-api/v10/tab/props.md';
import Events from '@ionic-internal/component-api/v10/tab/events.md';
import Methods from '@ionic-internal/component-api/v10/tab/methods.md';
import Parts from '@ionic-internal/component-api/v10/tab/parts.md';
import CustomProps from '@ionic-internal/component-api/v10/tab/custom-props.mdx';
import Slots from '@ionic-internal/component-api/v10/tab/slots.md';
