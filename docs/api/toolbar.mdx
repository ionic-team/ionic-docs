...
import Props from '@ionic-internal/component-api/v10/toolbar/props.mdx';
import Events from '@ionic-internal/component-api/v10/toolbar/events.mdx';
import Methods from '@ionic-internal/component-api/v10/toolbar/methods.mdx';
import Parts from '@ionic-internal/component-api/v10/toolbar/parts.mdx';
import CustomProps from '@ionic-internal/component-api/v10/toolbar/custom-props.mdx';
import Slots from '@ionic-internal/component-api/v10/toolbar/slots.mdx';
...
import Basic from '@site/static/usage/v10/toolbar/basic/index.mdx';
...
import Buttons from '@site/static/usage/v10/toolbar/buttons/index.mdx';
...
import Searchbars from '@site/static/usage/v10/toolbar/searchbars/index.mdx';
...
import Segments from '@site/static/usage/v10/toolbar/segments/index.mdx';
...
import ProgressBars from '@site/static/usage/v10/toolbar/progress-bars/index.mdx';
...
import Colors from '@site/static/usage/v10/toolbar/theming/colors/index.mdx';

<Colors />

### CSS Custom Properties

import CSSProps from '@site/static/usage/v10/toolbar/theming/css-properties/index.mdx';
