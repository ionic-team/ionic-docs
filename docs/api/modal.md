...
import Props from '@ionic-internal/component-api/v10/modal/props.mdx';
import Events from '@ionic-internal/component-api/v10/modal/events.mdx';
import Methods from '@ionic-internal/component-api/v10/modal/methods.mdx';
import Parts from '@ionic-internal/component-api/v10/modal/parts.mdx';
import CustomProps from '@ionic-internal/component-api/v10/modal/custom-props.mdx';
import Slots from '@ionic-internal/component-api/v10/modal/slots.mdx';
...
import InlineModalTriggerExample from '@site/static/usage/v10/modal/inline/basic/index.mdx';
...
import InlineModalIsOpenExample from '@site/static/usage/v10/modal/inline/is-open/index.mdx';
...
import ControllerExample from '@site/static/usage/v10/modal/controller/index.mdx';
...
import CanDismissBooleanExample from '@site/static/usage/v10/modal/can-dismiss/boolean/index.mdx';
...
import CanDismissFunctionExample from '@site/static/usage/v10/modal/can-dismiss/function/index.mdx';
...
import CanDismissPreventSwipeToCloseExample from '@site/static/usage/v10/modal/can-dismiss/prevent-swipe-to-close/index.mdx';
...
import CanDismissChildStateExample from '@site/static/usage/v10/modal/can-dismiss/child-state/index.mdx';
...
import CardExample from '@site/static/usage/v10/modal/card/basic/index.mdx';
...
import SheetExample from '@site/static/usage/v10/modal/sheet/basic/index.mdx';

<SheetExample />

### Interacting with background content

import SheetBackgroundContentExample from '@site/static/usage/v10/modal/sheet/background-content/index.mdx';
...
import SheetAutoHeightExample from '@site/static/usage/v10/modal/sheet/auto-height/index.mdx';
...
import SheetHandleBehaviorExample from '@site/static/usage/v10/modal/sheet/handle-behavior/index.mdx';
...
import SheetScrollingContentExample from '@site/static/usage/v10/modal/sheet/expand-to-scroll/index.mdx';
...
import ThemeExample from '@site/static/usage/v10/modal/styling/theming/index.mdx';
...
import AnimationsExample from '@site/static/usage/v10/modal/styling/animations/index.mdx';
...
import CustomDialogs from '@site/static/usage/v10/modal/custom-dialogs/index.mdx';
...
import DragStartEndEvents from '@site/static/usage/v10/modal/drag-start-end-events/index.mdx';
...
import DragMoveEvent from '@site/static/usage/v10/modal/drag-move-event/index.mdx';
...
import Mount from '@site/static/usage/v10/modal/performance/mount/index.mdx';
