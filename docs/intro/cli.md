...
![Three thumbnail images representing the blank, tabs, and side menu starter templates for Ionic apps.](/img/installation/start-app-thumbnails.png "Ionic App Starter Templates")
