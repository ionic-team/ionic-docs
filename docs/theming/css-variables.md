...
When using the Ionic CLI to start an Angular or React project, the `src/theme/variables.scss` file is created where you can override the default Ionic Variables.
