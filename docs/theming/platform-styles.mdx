...
There are many global variables that can be overridden by mode, including [Ionic's color variables](colors), [theme variables](themes) and [global component variables](advanced).
