...
| `--ion-margin`              | Adjust the margin of the [Margin attributes](../layout/css-utilities.mdx#margin)                     |
...
Refer to the [CSS Variables](css-variables.mdx) section for more information on how to get and set CSS variables.
