...
For [Cordova](../reference/glossary.mdx#cordova), Ionic maintains a [Web View plugin](https://github.com/ionic-team/cordova-plugin-ionic-webview). The plugin is provided by default when using the Ionic CLI.

## What is a Web View? {/* #what-is-a-web-view */}
