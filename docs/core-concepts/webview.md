...
![Diagram illustrating the architecture of a Web View, showing the interaction between the app, Web View, bridge, and hardware APIs on native and Ionic apps.](/img/building/webview-architecture.png "Web View Architecture Diagram")
