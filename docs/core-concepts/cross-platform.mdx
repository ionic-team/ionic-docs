...
### ブラウザのフォールバック {/* #browser-fallbacks */}
...
この場合、[Ionic のストレージライブラリ](https://github.com/ionic-team/ionic-storage)は複数の環境において最適な選択肢です。Ionic のストレージクラスは、十分にテストされた LocalForage ライブラリ上に構築され、適応性の高いストレージメカニズムを提供します。
