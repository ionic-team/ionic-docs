...
When an app is served, Ionic Studio starts a Dev Server with [Live Reload](../reference/glossary.mdx#livereload) and displays the app in a separate browser window, called a _Serve Window_.
...
<blockquote>
  ...
  iOS & Android](setup/native.mdx) documentation for setup guides.
</blockquote>
...
To debug running apps, see the docs for debugging [iOS Apps](../developing/ios.mdx#debugging-ios-apps) and [Android Apps](../developing/android.mdx#debugging-android-apps).
