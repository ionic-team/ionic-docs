...
- macOS or Windows 10
- Make sure you have the latest LTS release of [Node &amp; npm](../../intro/environment.mdx#node-npm) set up on your computer
- Optionally install [Git](../../intro/environment.mdx#git) for version control
