...
3. Optionally supply a Bundle ID (aka [Package ID](../reference/glossary.mdx#package-id)), which is used to identify your app when published. It's okay to leave this blank for now.
