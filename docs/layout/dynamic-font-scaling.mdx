...
2. Verify that the [typography.css](/layout/global-stylesheets.mdx#typographycss) file has been imported. This file is required for Dynamic Font Scaling to work.
