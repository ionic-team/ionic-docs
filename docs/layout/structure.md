...
import Header from '@site/static/usage/v10/header/basic/index.mdx';
...
import Footer from '@site/static/usage/v10/footer/basic/index.mdx';
...
import Tabs from '@site/static/usage/v10/tabs/router/index.mdx';
...
import Menu from '@site/static/usage/v10/menu/basic/index.mdx';
...
import SplitPane from '@site/static/usage/v10/split-pane/basic/index.mdx';
