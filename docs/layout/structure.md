...
import Header from '@site/static/usage/v10/header/basic/index.md';
...
import Footer from '@site/static/usage/v10/footer/basic/index.md';
...
import Tabs from '@site/static/usage/v10/tabs/router/index.md';
...
import Menu from '@site/static/usage/v10/menu/basic/index.md';
...
import SplitPane from '@site/static/usage/v10/split-pane/basic/index.md';
