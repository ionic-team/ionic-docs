...
Refer to [Ionic Packages](../intro/cdn) for how to include the global stylesheets based on the framework and [CSS Utilities](css-utilities) for how to use the optional utilities.
