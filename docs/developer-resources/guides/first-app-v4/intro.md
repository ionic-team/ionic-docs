...
![Before and after screenshots of an Ionic app showing the transformation from a blank Tab Two to a Photo Gallery with images.](/img/guides/first-app-v3/gallery-combined.png "Ionic App Before and After Photo Gallery")
