...
## Add Cordova iOS and Android Platforms {/* #add-cordova-ios-and-android-platforms */}
...
## Add the Camera Dependencies via the CLI {/* #add-the-camera-dependencies-via-the-cli */}
...
## Add Camera plugin to Angular App Module {/* #add-camera-plugin-to-angular-app-module */}
...
## Add the Camera to the Gallery page {/* #add-the-camera-to-the-gallery-page */}
