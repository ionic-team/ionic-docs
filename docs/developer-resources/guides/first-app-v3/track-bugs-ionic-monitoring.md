...
![Screenshot of an Ionic Monitoring event showing an error 'takePhoto is not a function' with status 'New'.](/img/guides/first-app-v3/monitoring-event.png "Ionic Monitoring Event Overview")
...
![Detailed view of an Ionic Monitoring event log displaying a TypeError stack trace and error details such as device, browser, and operating system.](/img/guides/first-app-v3/monitoring-details.png "Detailed Ionic Monitoring Event Log")
