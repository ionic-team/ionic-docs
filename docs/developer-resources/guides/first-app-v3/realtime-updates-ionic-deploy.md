...
![Screenshot showing the Deploy Builds section in Appflow with a commit labeled 'master'.](/img/guides/first-app-v3/deploy-channel.png "Appflow Deploy Channel")
...
![Screenshot of the Appflow dashboard showing how to revert to a previous build by assigning it to a channel.](/img/guides/first-app-v3/deploy-revertChange.png "Appflow Deploy Revert Change")
