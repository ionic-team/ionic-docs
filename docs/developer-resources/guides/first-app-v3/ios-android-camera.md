...
DevApp で、アプリが表示されるはずです。表示されない場合や、このアプリの作成中に問題が発生した場合は、[DevApp のドキュメント](https://ionicframework.com/docs/pro/devapp/)を参照してください。
...
次に、アプリをフォトギャラリーに変換する方法と、写真をデバイスに保存する方法について説明します！
