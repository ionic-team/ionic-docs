...
<DocsCard
  header="Button"
  href="api/button"
  icon={require('./components/_assets/img/component-button-icon.png').default}
>
...
<DocsCard
  header="Checkbox"
  href="api/checkbox"
  icon={require('./components/_assets/img/component-checkbox-icon.png').default}
>
...
<DocsCard
  header="Content"
  href="api/content"
  icon={require('./components/_assets/img/component-content-icon.png').default}
>
...
<DocsCard
  ...
  href="api/datetime"
  icon={require('./components/_assets/img/component-datetimepicker-icon.png').default}
>
...
<DocsCard
  ...
  href="api/fab"
  icon={require('./components/_assets/img/component-fab-icon.png').default}
>
...
<DocsCard
  ...
  img={require('./components/_assets/img/feature-component-icons-icon.png').default}
>
...
<DocsCard
  ...
  icon={require('./components/_assets/img/component-infinitescroll-icon.png').default}
>
...
<DocsCard
  header="Navigation"
  href="api/nav"
  img={require('./components/_assets/img/feature-component-navigation-icon.png').default}
>
...
<DocsCard
  header="Popover"
  href="api/popover"
  icon={require('./components/_assets/img/component-popover-icon.png').default}
>
...
<DocsCard
  ...
  href="api/progress-bar"
  icon={require('./components/_assets/img/component-progress-icon.png').default}
>
...
<DocsCard
  header="Refresher"
  href="api/refresher"
  icon={require('./components/_assets/img/component-refresher-icon.png').default}
>
...
<DocsCard
  header="Searchbar"
  href="api/searchbar"
  img={require('./components/_assets/img/feature-component-search-icon.png').default}
>
...
<DocsCard
  header="Reorder"
  href="api/reorder"
  icon={require('./components/_assets/img/component-reorder-icon.png').default}
>
...
<DocsCard
  header="Routing"
  href="api/router"
  icon={require('./components/_assets/img/component-routing-icon.png').default}
>
...
<DocsCard
  header="Segment"
  href="api/segment"
  icon={require('./components/_assets/img/component-segment-icon.png').default}
>
...
<DocsCard
  header="Select"
  href="api/select"
  icon={require('./components/_assets/img/component-select-icon.png').default}
>
...
<DocsCard
  header="Slides"
  href="api/slides"
  icon={require('./components/_assets/img/component-slides-icon.png').default}
>
...
<DocsCard
  header="Tabs"
  href="api/tabs"
  img={require('./components/_assets/img/feature-component-tabs-icon.png').default}
>
...
<DocsCard
  header="Toggle"
  href="api/toggle"
  icon={require('./components/_assets/img/component-toggle-icon.png').default}
>
