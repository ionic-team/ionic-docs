...
:::info[非互換変更]
Ionic 4 から Ionic 5 への**非互換変更の完全なリスト**については、Ionic Framework リポジトリの[非互換変更ドキュメント](https://github.com/ionic-team/ionic-framework/blob/main/BREAKING_ARCHIVE/v5.md)を参照してください。
:::
