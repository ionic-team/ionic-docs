...
:::info[破壊的変更]
Ionic 6 から Ionic 7 への**破壊的変更の完全なリスト**については、Ionic Framework リポジトリの[破壊的変更ドキュメント](https://github.com/ionic-team/ionic-framework/blob/main/BREAKING.md#version-7x)を参照してください。
:::
...
## あなたのコードのアップデート {/* #updating-your-code */}
...
## アップグレードに助けが必要？ {/* #need-help-upgrading */}

必ず[Ionic 7 破壊的変更ガイド](https://github.com/ionic-team/ionic-framework/blob/main/BREAKING.md#version-7x)を確認してください。開発者が把握しておく必要がある可能性のあるデフォルトのプロパティや CSS 変数の値に関する変更がいくつかあります。このページには、ユーザーの操作が必要な破壊的変更のみが記載されています。
