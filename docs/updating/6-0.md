...
4. Remove any usage of the `open` method. To present the datetime in an overlay, place it inside of an `ion-modal` or an `ion-popover` component. Refer to the [ion-datetime Usage Examples](../api/datetime#usage) for more information.
