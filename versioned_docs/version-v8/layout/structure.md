...
import Header from '@site/static/usage/v8/header/basic/index.mdx';
...
import Footer from '@site/static/usage/v8/footer/basic/index.mdx';
...
import Tabs from '@site/static/usage/v8/tabs/router/index.mdx';
...
import Menu from '@site/static/usage/v8/menu/basic/index.mdx';
...
import SplitPane from '@site/static/usage/v8/split-pane/basic/index.mdx';
