...
<section id="cli">
  ...
  <p>
    ...
    <a href="https://ionicframework.com/docs/cli">Ionic's CLI</a>. Ionic's CLI can be used for a number of things, such as
...
<section id="gulp">
  ...
  <p>
    ...
    <a href="#es2015-es6">ES6</a> to <a href="#es5">ES5</a>, turning
...
<section id="livereload">
  ...
  <p>
    ...
    <a href="../core-concepts/webview">Web View</a> when it detects changes in your app. In some cases, it can replace parts
...
<section id="package-id">
  ...
  <p>
    ...
    <strong>Package ID</strong> is used for identifying apps published to the App Store/Play Store. It is a string formatted
    in <a href="https://en.wikipedia.org/wiki/Reverse_domain_name_notation" target="_blank">
...
<section id="transpiler">
  ...
  <p>
    ...
    <em>transpilation</em> in Ionic Framework is converting <a href="#es2015-es6">ES2015/ES6</a>(<a href="#typescript">
      TypeScript
    </a>) to <a href="#es5">ES5</a> (traditional JavaScript).
  </p>
</section>
