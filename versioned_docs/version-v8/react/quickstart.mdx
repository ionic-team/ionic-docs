...
Navigating can also be performed programmatically using React Router's `history` prop. Refer to the [React Navigation documentation](/docs/react/navigation.mdx#navigating-using-history) for more information.
