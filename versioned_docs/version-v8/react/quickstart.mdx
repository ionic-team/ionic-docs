...
Navigating can also be performed programmatically using React Router's `history` prop. Refer to the [React Navigation documentation](/react/navigation.mdx#navigation) for more information.
