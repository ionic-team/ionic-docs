...
import Props from '@ionic-internal/component-api/v6/item/props.mdx';
import Events from '@ionic-internal/component-api/v6/item/events.mdx';
import Methods from '@ionic-internal/component-api/v6/item/methods.mdx';
import Parts from '@ionic-internal/component-api/v6/item/parts.mdx';
import CustomProps from '@ionic-internal/component-api/v6/item/custom-props.mdx';
import Slots from '@ionic-internal/component-api/v6/item/slots.mdx';
...
import Basic from '@site/static/usage/v6/item/basic/index.mdx';
...
import Clickable from '@site/static/usage/v6/item/clickable/index.mdx';
...
import DetailArrows from '@site/static/usage/v6/item/detail-arrows/index.mdx';
...
This feature is not enabled by default on clickable items for the      mode, but it can be enabled by setting the following CSS variable:
...
import Lines from '@site/static/usage/v6/item/lines/index.mdx';
...
import Media from '@site/static/usage/v6/item/media/index.mdx';
...
import Buttons from '@site/static/usage/v6/item/buttons/index.mdx';

<Buttons />

## Icons in Items

import Icons from '@site/static/usage/v6/item/icons/index.mdx';

<Icons />

## Item Inputs

import Inputs from '@site/static/usage/v6/item/inputs/index.mdx';
...
import Colors from '@site/static/usage/v6/item/theming/colors/index.mdx';

<Colors />

### CSS Shadow Parts

import CSSParts from '@site/static/usage/v6/item/theming/css-shadow-parts/index.mdx';

<CSSParts />

### CSS Custom Properties

import CSSProps from '@site/static/usage/v6/item/theming/css-properties/index.mdx';
...
import InputHighlight from '@site/static/usage/v6/item/theming/input-highlight/index.mdx';
