...
import Props from '@ionic-internal/component-api/v6/select/props.mdx';
import Events from '@ionic-internal/component-api/v6/select/events.mdx';
import Methods from '@ionic-internal/component-api/v6/select/methods.mdx';
import Parts from '@ionic-internal/component-api/v6/select/parts.mdx';
import CustomProps from '@ionic-internal/component-api/v6/select/custom-props.mdx';
import Slots from '@ionic-internal/component-api/v6/select/slots.mdx';
...
import SingleSelectionExample from '@site/static/usage/v6/select/basic/single-selection/index.mdx';
...
import ActionSheetExample from '@site/static/usage/v6/select/interfaces/action-sheet/index.mdx';

<ActionSheetExample />

### Popover

import PopoverExample from '@site/static/usage/v6/select/interfaces/popover/index.mdx';
...
import MultipleSelectionExample from '@site/static/usage/v6/select/basic/multiple-selection/index.mdx';
...
import RespondingToInteractionExample from '@site/static/usage/v6/select/basic/responding-to-interaction/index.mdx';
...
import UsingCompareWithExample from '@site/static/usage/v6/select/objects-as-values/using-comparewith/index.mdx';

<UsingCompareWithExample />

### Object Values and Multiple Selection

import ObjectValuesAndMultipleSelectionExample from '@site/static/usage/v6/select/objects-as-values/multiple-selection/index.mdx';
...
import ButtonTextExample from '@site/static/usage/v6/select/customization/button-text/index.mdx';
...
import InterfaceOptionsExample from '@site/static/usage/v6/select/customization/interface-options/index.mdx';
...
import StylingSelectExample from '@site/static/usage/v6/select/customization/styling-select/index.mdx';
...
import TypeaheadExample from '@site/static/usage/v6/select/typeahead/index.mdx';
