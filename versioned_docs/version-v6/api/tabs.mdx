...
import Props from '@ionic-internal/component-api/v6/tabs/props.mdx';
import Events from '@ionic-internal/component-api/v6/tabs/events.mdx';
import Methods from '@ionic-internal/component-api/v6/tabs/methods.mdx';
import Parts from '@ionic-internal/component-api/v6/tabs/parts.mdx';
import CustomProps from '@ionic-internal/component-api/v6/tabs/custom-props.mdx';
import Slots from '@ionic-internal/component-api/v6/tabs/slots.mdx';
...
import Router from '@site/static/usage/v6/tabs/router/index.mdx';
