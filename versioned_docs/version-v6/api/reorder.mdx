...
import Props from '@ionic-internal/component-api/v6/reorder/props.mdx';
import Events from '@ionic-internal/component-api/v6/reorder/events.mdx';
import Methods from '@ionic-internal/component-api/v6/reorder/methods.mdx';
import Parts from '@ionic-internal/component-api/v6/reorder/parts.mdx';
import CustomProps from '@ionic-internal/component-api/v6/reorder/custom-props.mdx';
import Slots from '@ionic-internal/component-api/v6/reorder/slots.mdx';
...
import Basic from '@site/static/usage/v6/reorder/basic/index.mdx';
...
import TogglingDisabled from '@site/static/usage/v6/reorder/toggling-disabled/index.mdx';
...
import CustomIcon from '@site/static/usage/v6/reorder/custom-icon/index.mdx';
...
import Wrapper from '@site/static/usage/v6/reorder/wrapper/index.mdx';
...
import UpdatingData from '@site/static/usage/v6/reorder/updating-data/index.mdx';
...
import CustomScrollTarget from '@site/static/usage/v6/reorder/custom-scroll-target/index.mdx';
