...
import Props from '@ionic-internal/component-api/v6/router-link/props.mdx';
import Events from '@ionic-internal/component-api/v6/router-link/events.mdx';
import Methods from '@ionic-internal/component-api/v6/router-link/methods.mdx';
import Parts from '@ionic-internal/component-api/v6/router-link/parts.mdx';
import CustomProps from '@ionic-internal/component-api/v6/router-link/custom-props.mdx';
import Slots from '@ionic-internal/component-api/v6/router-link/slots.mdx';
