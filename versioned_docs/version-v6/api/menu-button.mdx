...
import Props from '@ionic-internal/component-api/v6/menu-button/props.mdx';
import Events from '@ionic-internal/component-api/v6/menu-button/events.mdx';
import Methods from '@ionic-internal/component-api/v6/menu-button/methods.mdx';
import Parts from '@ionic-internal/component-api/v6/menu-button/parts.mdx';
import CustomProps from '@ionic-internal/component-api/v6/menu-button/custom-props.mdx';
import Slots from '@ionic-internal/component-api/v6/menu-button/slots.mdx';
