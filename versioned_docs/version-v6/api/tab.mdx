...
import Props from '@ionic-internal/component-api/v6/tab/props.mdx';
import Events from '@ionic-internal/component-api/v6/tab/events.mdx';
import Methods from '@ionic-internal/component-api/v6/tab/methods.mdx';
import Parts from '@ionic-internal/component-api/v6/tab/parts.mdx';
import CustomProps from '@ionic-internal/component-api/v6/tab/custom-props.mdx';
import Slots from '@ionic-internal/component-api/v6/tab/slots.mdx';
