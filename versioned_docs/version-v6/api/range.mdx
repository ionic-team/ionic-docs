...
import Props from '@ionic-internal/component-api/v6/range/props.mdx';
import Events from '@ionic-internal/component-api/v6/range/events.mdx';
import Methods from '@ionic-internal/component-api/v6/range/methods.mdx';
import Parts from '@ionic-internal/component-api/v6/range/parts.mdx';
import CustomProps from '@ionic-internal/component-api/v6/range/custom-props.mdx';
import Slots from '@ionic-internal/component-api/v6/range/slots.mdx';
...
import Basic from '@site/static/usage/v6/range/basic/index.mdx';
...
import SlotsPlayground from '@site/static/usage/v6/range/slots/index.mdx';
...
import DualKnobs from '@site/static/usage/v6/range/dual-knobs/index.mdx';
...
import Pins from '@site/static/usage/v6/range/pins/index.mdx';
...
import SnappingTicks from '@site/static/usage/v6/range/snapping-ticks/index.mdx';
...
import IonChangeEvent from '@site/static/usage/v6/range/ion-change-event/index.mdx';
...
import IonKnobMoveEvent from '@site/static/usage/v6/range/ion-knob-move-event/index.mdx';
...
import CSSProps from '@site/static/usage/v6/range/theming/css-properties/index.mdx';
...
import CSSParts from '@site/static/usage/v6/range/theming/css-shadow-parts/index.mdx';
