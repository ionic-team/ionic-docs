...
import Props from '@ionic-internal/component-api/v6/toggle/props.mdx';
import Events from '@ionic-internal/component-api/v6/toggle/events.mdx';
import Methods from '@ionic-internal/component-api/v6/toggle/methods.mdx';
import Parts from '@ionic-internal/component-api/v6/toggle/parts.mdx';
import CustomProps from '@ionic-internal/component-api/v6/toggle/custom-props.mdx';
import Slots from '@ionic-internal/component-api/v6/toggle/slots.mdx';
...
import Basic from '@site/static/usage/v6/toggle/basic/index.mdx';
...
import OnOff from '@site/static/usage/v6/toggle/on-off/index.mdx';
...
import Colors from '@site/static/usage/v6/toggle/theming/colors/index.mdx';
...
import CSSProps from '@site/static/usage/v6/toggle/theming/css-properties/index.mdx';
...
import CSSParts from '@site/static/usage/v6/toggle/theming/css-shadow-parts/index.mdx';
