...
import Props from '@ionic-internal/component-api/v6/list/props.mdx';
import Events from '@ionic-internal/component-api/v6/list/events.mdx';
import Methods from '@ionic-internal/component-api/v6/list/methods.mdx';
import Parts from '@ionic-internal/component-api/v6/list/parts.mdx';
import CustomProps from '@ionic-internal/component-api/v6/list/custom-props.mdx';
import Slots from '@ionic-internal/component-api/v6/list/slots.mdx';
...
import Basic from '@site/static/usage/v6/list/basic/index.mdx';
...
import Inset from '@site/static/usage/v6/list/inset/index.mdx';
...
import Lines from '@site/static/usage/v6/list/lines/index.mdx';
