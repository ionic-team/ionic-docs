...
The [buttons](./buttons) component can be used with the [`collapse`](./buttons#collapse) property to additionally display in the header as the toolbar is collapsed.
