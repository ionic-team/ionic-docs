...
import Props from '@ionic-internal/component-api/v6/select-option/props.mdx';
import Events from '@ionic-internal/component-api/v6/select-option/events.mdx';
import Methods from '@ionic-internal/component-api/v6/select-option/methods.mdx';
import Parts from '@ionic-internal/component-api/v6/select-option/parts.mdx';
import CustomProps from '@ionic-internal/component-api/v6/select-option/custom-props.mdx';
import Slots from '@ionic-internal/component-api/v6/select-option/slots.mdx';
