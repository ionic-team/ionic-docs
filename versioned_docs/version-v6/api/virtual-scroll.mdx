...
Ionic Angular の仮想スクロールのオプションについては、[Angular 仮想スクロールガイド](../angular/virtual-scroll.mdx)を参照してください。

## React

Ionic React での仮想スクロールのオプションについては、[React 仮想スクロールガイド](../react/virtual-scroll.mdx)を参照してください。

## Vue

Ionic Vue での仮想スクロールのオプションについては、[Vue 仮想スクロールガイド](../vue/virtual-scroll.mdx)を参照してください。
