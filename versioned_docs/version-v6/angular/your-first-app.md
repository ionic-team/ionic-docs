...
![Animated GIF showing the Ionic Photo Gallery app's live reload feature in a code editor and web browser.](/img/guides/first-app-cap-ng/email-photogallery.gif "Ionic Photo Gallery App Development")
