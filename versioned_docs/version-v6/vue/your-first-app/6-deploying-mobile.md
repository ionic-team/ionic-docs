...
![iOS permission prompt to access the camera on the left, and a photo taken with the app on the right.](/img/guides/first-app-cap-ng/ios-permissions-photo.png "iOS Camera Permission Prompt and Photo Result")
...
![Android Studio interface with the Run button highlighted, showing a connected device.](/img/guides/first-app-cap-ng/android-device.png "Android Studio Run Configuration")
...
![Android permission prompt to access the camera on the left, and a photo taken with the app on the right.](/img/guides/first-app-cap-ng/android-permissions-photo.png "Android Camera Permission Prompt and Photo Result")
