...
:::note
The `useBackButton` callback will only fire when your app is running in Capacitor or Cordova. See [Hardware Back Button in Capacitor and Cordova](/developing/hardware-back-button.mdx#hardware-back-button-in-capacitor-and-cordova) for more information.
:::
