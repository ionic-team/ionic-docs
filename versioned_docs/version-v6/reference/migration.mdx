...
Please see the [Ionic 6 Migration Guide](/updating/6-0).

## Migrating from Ionic 4.x to Ionic 5.x

Please see the [Ionic 5 Migration Guide](/updating/5-0).

## Migrating to Ionic 4.0

Please see the [Ionic 4 Migration Guide](/updating/4-0).
