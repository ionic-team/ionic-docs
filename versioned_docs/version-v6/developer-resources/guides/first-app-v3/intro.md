...
![A before and after comparison of an Ionic app, showing a basic tab layout on the left and a photo gallery feature on the right.](/img/guides/first-app-v3/gallery-combined.png "Before and After Ionic App Transformation")
...
![Animated GIF demonstrating the addition of a photo gallery feature to an Ionic app, with a user interface showing code and the resulting photo gallery.](/img/guides/first-app-v3/email-photogallery.gif "Ionic Photo Gallery Functionality")
