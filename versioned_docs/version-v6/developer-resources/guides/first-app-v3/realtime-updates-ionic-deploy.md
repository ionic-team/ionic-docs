...
![Screenshot displaying the Deploy Builds in Appflow with a commit labeled 'set name to Photo Gallery' being deployed to revert a previous change.](/img/guides/first-app-v3/deploy-revertChange.png "Appflow Deploy Revert Change")
