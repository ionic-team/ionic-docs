...
<head>
  ...
  <meta
    name="description"
    content="Build your first Ionic React App. With one codebase, you can build an Ionic Framework application for any platform using only HTML, CSS, and JavaScript."
  />
</head>
