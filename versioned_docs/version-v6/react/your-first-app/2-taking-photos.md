...
![Screenshot of a photo gallery app displaying a selfie taken with the device's camera.](/img/guides/first-app-cap-ng/camera-web.png "Photo Gallery Selfie Example")
