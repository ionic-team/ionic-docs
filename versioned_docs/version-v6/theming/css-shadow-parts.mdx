...
- It is a [Shadow DOM](../reference/glossary#shadow) component. If it is a [Scoped](../reference/glossary#scoped) or Light DOM component, the child elements can be targeted directly. If a component is Scoped or Shadow, it will be listed by its name on its [component documentation page](../components.md).
