...
:::info[破壊的変更]
Ionic 6 から Ionic 7 への **破壊的変更の完全なリスト** は、Ionic Framework リポジトリの [破壊的変更ドキュメント](https://github.com/ionic-team/ionic-framework/blob/main/BREAKING.md#version-7x) を参照してください。
:::
