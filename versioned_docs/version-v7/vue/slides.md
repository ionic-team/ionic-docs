...
`ion-slides`は v6.0.0 で非推奨になり、v7.0.0 で削除されました。直接 Swiper.js ライブラリを使用することをお勧めします。移行手順は下記に詳細があります。
:::
...
:::note
モジュールの完全なリストについては、<a href="https://swiperjs.com/vue#usage" target="_blank" rel="noopener noreferrer">Swiper の Vue 使用ドキュメント</a>を参照してください。
:::
...
:::note
Swiper Vue で利用可能なすべてのプロパティは、<a href="https://swiperjs.com/vue#swiper-props" target="_blank" rel="noopener noreferrer">Swiper Vue props ドキュメント</a>で確認できます。
:::
...
:::note
Swiper Vue で利用可能なすべてのイベントは、<a href="https://swiperjs.com/vue#swiper-events" target="_blank" rel="noopener noreferrer">Swiper Vue events ドキュメント</a>で確認できます。
:::
...
:::note
Swiper のエフェクトに関する詳細は、<a href="https://swiperjs.com/vue#effects" target="_blank" rel="noopener noreferrer">Swiper Vue effects ドキュメント</a>を参照してください。
:::
