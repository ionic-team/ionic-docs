...
import Basic from '@site/static/usage/v7/ripple-effect/basic/index.mdx';
...
import Type from '@site/static/usage/v7/ripple-effect/type/index.mdx';
...
import Customizing from '@site/static/usage/v7/ripple-effect/customizing/index.mdx';
