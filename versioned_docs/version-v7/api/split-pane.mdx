...
import Basic from '@site/static/usage/v7/split-pane/basic/index.mdx';
...
import CSSProperties from '@site/static/usage/v7/split-pane/theming/css-properties/index.mdx';
