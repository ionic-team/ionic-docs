...
import Props from '@ionic-internal/component-api/v7/router/props.mdx';
import Events from '@ionic-internal/component-api/v7/router/events.mdx';
import Methods from '@ionic-internal/component-api/v7/router/methods.mdx';
import Parts from '@ionic-internal/component-api/v7/router/parts.mdx';
import CustomProps from '@ionic-internal/component-api/v7/router/custom-props.mdx';
import Slots from '@ionic-internal/component-api/v7/router/slots.mdx';
