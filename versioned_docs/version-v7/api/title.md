...
import Props from '@ionic-internal/component-api/v7/title/props.mdx';
import Events from '@ionic-internal/component-api/v7/title/events.mdx';
import Methods from '@ionic-internal/component-api/v7/title/methods.mdx';
import Parts from '@ionic-internal/component-api/v7/title/parts.mdx';
import CustomProps from '@ionic-internal/component-api/v7/title/custom-props.mdx';
import Slots from '@ionic-internal/component-api/v7/title/slots.mdx';
