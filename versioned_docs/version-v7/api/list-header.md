...
import Props from '@ionic-internal/component-api/v7/list-header/props.mdx';
import Events from '@ionic-internal/component-api/v7/list-header/events.mdx';
import Methods from '@ionic-internal/component-api/v7/list-header/methods.mdx';
import Parts from '@ionic-internal/component-api/v7/list-header/parts.mdx';
import CustomProps from '@ionic-internal/component-api/v7/list-header/custom-props.mdx';
import Slots from '@ionic-internal/component-api/v7/list-header/slots.mdx';
