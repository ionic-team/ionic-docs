...
import Props from '@ionic-internal/component-api/v7/item-option/props.mdx';
import Events from '@ionic-internal/component-api/v7/item-option/events.mdx';
import Methods from '@ionic-internal/component-api/v7/item-option/methods.mdx';
import Parts from '@ionic-internal/component-api/v7/item-option/parts.mdx';
import CustomProps from '@ionic-internal/component-api/v7/item-option/custom-props.mdx';
import Slots from '@ionic-internal/component-api/v7/item-option/slots.mdx';
