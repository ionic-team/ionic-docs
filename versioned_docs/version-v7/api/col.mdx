...
import Props from '@ionic-internal/component-api/v7/col/props.mdx';
import Events from '@ionic-internal/component-api/v7/col/events.mdx';
import Methods from '@ionic-internal/component-api/v7/col/methods.mdx';
import Parts from '@ionic-internal/component-api/v7/col/parts.mdx';
import CustomProps from '@ionic-internal/component-api/v7/col/custom-props.mdx';
import Slots from '@ionic-internal/component-api/v7/col/slots.mdx';
