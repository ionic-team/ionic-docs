...
import Basic from '@site/static/usage/v7/thumbnail/basic/index.mdx';

<Basic />

## Item Thumbnails

import Item from '@site/static/usage/v7/thumbnail/item/index.mdx';
...
import CSSProps from '@site/static/usage/v7/thumbnail/theming/css-properties/index.mdx';
