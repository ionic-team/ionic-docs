...
import Basic from '@site/static/usage/v7/breadcrumbs/basic/index.mdx';
...
import IconsOnItems from '@site/static/usage/v7/breadcrumbs/icons/icons-on-items/index.mdx';

<IconsOnItems />

### Custom Separators

import CustomSeparators from '@site/static/usage/v7/breadcrumbs/icons/custom-separators/index.mdx';
...
import MaxItems from '@site/static/usage/v7/breadcrumbs/collapsing-items/max-items/index.mdx';
...
import ItemsBeforeAfter from '@site/static/usage/v7/breadcrumbs/collapsing-items/items-before-after/index.mdx';
...
import ExpandOnClick from '@site/static/usage/v7/breadcrumbs/collapsing-items/expand-on-click/index.mdx';
...
import PopoverOnClick from '@site/static/usage/v7/breadcrumbs/collapsing-items/popover-on-click/index.mdx';
...
import Colors from '@site/static/usage/v7/breadcrumbs/theming/colors/index.mdx';

<Colors />

### CSS Custom Properties

import CSSProps from '@site/static/usage/v7/breadcrumbs/theming/css-properties/index.mdx';
