...
import Basic from '@site/static/usage/v7/buttons/basic/index.mdx';
...
import Placement from '@site/static/usage/v7/buttons/placement/index.mdx';
...
import Types from '@site/static/usage/v7/buttons/types/index.mdx';
