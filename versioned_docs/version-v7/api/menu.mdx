...
import Basic from '@site/static/usage/v7/menu/basic/index.mdx';
...
import MenuToggle from '@site/static/usage/v7/menu/toggle/index.mdx';
...
import MenuType from '@site/static/usage/v7/menu/type/index.mdx';
...
import Sides from '@site/static/usage/v7/menu/sides/index.mdx';
...
import Multiple from '@site/static/usage/v7/menu/multiple/index.mdx';
...
import Theming from '@site/static/usage/v7/menu/theming/index.mdx';
