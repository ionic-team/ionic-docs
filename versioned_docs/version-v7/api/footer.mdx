...
import Basic from '@site/static/usage/v7/footer/basic/index.mdx';
...
import Translucent from '@site/static/usage/v7/footer/translucent/index.mdx';
...
import Fade from '@site/static/usage/v7/footer/fade/index.mdx';
...
import CustomScrollTarget from '@site/static/usage/v7/footer/custom-scroll-target/index.mdx';
...
import NoBorder from '@site/static/usage/v7/footer/no-border/index.mdx';
