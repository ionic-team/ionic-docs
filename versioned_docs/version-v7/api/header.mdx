...
import Basic from '@site/static/usage/v7/header/basic/index.mdx';
...
import Translucent from '@site/static/usage/v7/header/translucent/index.mdx';
...
import Condense from '@site/static/usage/v7/header/condense/index.mdx';
...
import Fade from '@site/static/usage/v7/header/fade/index.mdx';
...
import CustomScrollTarget from '@site/static/usage/v7/header/custom-scroll-target/index.mdx';
...
import NoBorder from '@site/static/usage/v7/header/no-border/index.mdx';
