...
import Props from '@ionic-internal/component-api/v7/img/props.mdx';
import Events from '@ionic-internal/component-api/v7/img/events.mdx';
import Methods from '@ionic-internal/component-api/v7/img/methods.mdx';
import Parts from '@ionic-internal/component-api/v7/img/parts.mdx';
import CustomProps from '@ionic-internal/component-api/v7/img/custom-props.mdx';
import Slots from '@ionic-internal/component-api/v7/img/slots.mdx';
