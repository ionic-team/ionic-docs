...
import Props from '@ionic-internal/component-api/v7/card-title/props.mdx';
import Events from '@ionic-internal/component-api/v7/card-title/events.mdx';
import Methods from '@ionic-internal/component-api/v7/card-title/methods.mdx';
import Parts from '@ionic-internal/component-api/v7/card-title/parts.mdx';
import CustomProps from '@ionic-internal/component-api/v7/card-title/custom-props.mdx';
import Slots from '@ionic-internal/component-api/v7/card-title/slots.mdx';
