...
import Inline from '@site/static/usage/v7/loading/inline/index.mdx';

<Inline />

### Controller

import Controller from '@site/static/usage/v7/loading/controller/index.mdx';
...
import Spinners from '@site/static/usage/v7/loading/spinners/index.mdx';
...
import Theming from '@site/static/usage/v7/loading/theming/index.mdx';
