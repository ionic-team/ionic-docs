...
![Animated GIF showing the live reload feature in the Ionic Photo Gallery app within a code editor and web browser.](/img/guides/first-app-cap-ng/email-photogallery.gif "Ionic Photo Gallery App Live Reload")
