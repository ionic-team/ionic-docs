...
![Screenshot of Ionic's default Sass color variables for theming.](/img/guides/first-app-v3/v3-theming.png "Default Ionic Sass Variables")
...
![Screenshot showing customized Sass color variables with base and contrast properties.](/img/guides/first-app-v3/v3-themeColors.png "Customized Ionic Sass Variables")
...
![Comparison of Ionic app interfaces on iOS and Android platforms.](/img/guides/first-app-v3/ion-lab-comparison.png "Ionic Platform Specific Styles")
...
![Ionic app interface with Material Design styling applied.](/img/guides/first-app-v3/ion-lab-md-styling.png "Ionic Material Design Styling")
