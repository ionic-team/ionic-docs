...
import Header from '@site/static/usage/v7/header/basic/index.mdx';
...
import Footer from '@site/static/usage/v7/footer/basic/index.mdx';
...
import Tabs from '@site/static/usage/v7/tabs/router/index.mdx';
...
import Menu from '@site/static/usage/v7/menu/basic/index.mdx';
...
import SplitPane from '@site/static/usage/v7/split-pane/basic/index.mdx';
