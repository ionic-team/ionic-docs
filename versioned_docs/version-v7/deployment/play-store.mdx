...
![『新しいリリースを作成』ボタンを指す矢印付きのGoogle Playコンソールのプロダクションタブ。](https://blog.ionicframework.com/wp-content/uploads/2021/12/newapps-release-1024x561.png 'Google Play Consoleでの新しいリリース作成')

Under the App integrity section, click the **Change app signing key** button:

![『アプリ署名キーを変更』ボタンが強調表示されたGoogle Playコンソールのアプリ整合性セクション。](https://blog.ionicframework.com/wp-content/uploads/2021/12/newapps-signingkey.png 'Google Play Consoleのアプリ署名キー変更オプション')
...
![『Javaキーストアからキーをエクスポートしてアップロード』オプションを表示しているGoogle Playコンソール。](https://blog.ionicframework.com/wp-content/uploads/2021/12/newapps-export-1024x564.png 'Google Play Consoleのキーのエクスポートとアップロード')
...
![Google PlayコンソールでのPlayアプリ署名のオプトインオプション。](https://blog.ionicframework.com/wp-content/uploads/2021/12/existingapps-optin.png 'Google Play ConsoleでPlayアプリ署名を有効化')
...
![『CREATE APPLICATION』ボタンが強調表示されたGoogle Playストア開発者コンソール。](/img/publishing/newAppGPlay.png 'Google Playストアのアプリケーション作成ボタン')
