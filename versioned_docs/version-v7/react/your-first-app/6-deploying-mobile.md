...
![Screenshot of Xcode's Signing & Capabilities tab for an iOS app project.](/img/guides/first-app-cap-ng/xcode-signing.png "Xcode Signing & Capabilities")
...
![Screenshot highlighting the Build button in Xcode to compile and run an iOS app.](/img/guides/first-app-cap-ng/xcode-build-button.png "Xcode Build Button")
...
![Two iPhones side by side, one displaying the camera permission prompt and the other showing a photo taken with the app.](/img/guides/first-app-cap-ng/ios-permissions-photo.png "iOS Camera Permission Prompt and Photo Result")
...
![Screenshot of Android Studio with the AndroidManifest.xml file open, showing permissions configuration.](/img/guides/first-app-cap-ng/android-manifest.png "AndroidManifest.xml Configuration")
...
![Screenshot of Android Studio with the Run configuration dialog open, ready to launch the app on a device.](/img/guides/first-app-cap-ng/android-device.png "Android Studio Run Configuration")
...
![Two Android phones side by side, one displaying the camera permission prompt and the other showing a photo taken with the app.](/img/guides/first-app-cap-ng/android-permissions-photo.png "Android Camera Permission Prompt and Photo Result")
