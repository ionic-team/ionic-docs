...
Genymotion is a third-party Android emulator. It is extremely fast, and is useful for quickly testing your app on Android. Check out our [resource section](/developing/tips.mdx#using-the-genymotion-android-emulator) on Genymotion for more info.
