...
import AutomaticDarkMode from '@site/static/usage/v7/theming/automatic-dark-mode/index.mdx';
...
import ManualDarkMode from '@site/static/usage/v7/theming/manual-dark-mode/index.mdx';
