...
Now, start building out the app using some of the [Ionic UI components](../components.mdx).
...
Ionic React projects are just like React projects, leveraging [react-dom](https://reactjs.org/docs/react-dom.html) and with setup normally found in a [Create React App (CRA)](https://github.com/facebook/create-react-app) app. For [routing and navigation](navigation.mdx), React Router is used under the hood.
