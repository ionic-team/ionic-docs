...
![A person smiling for a selfie displayed in a web-based photo gallery interface.](/img/guides/first-app-cap-ng/camera-web.png "Webcam Selfie in Photo Gallery")
