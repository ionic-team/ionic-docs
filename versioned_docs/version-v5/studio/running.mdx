...
<figure class="device">
  <img alt="Serve Window" src={require('./_assets/img/ss-serve-window.png').default} />
</figure>
...
<figure>
  <img alt="Chrome DevTools" src={require('./_assets/img/ss-devtools.png').default} />
</figure>
...
<figure>
  <img alt="Run Modal" src={require('./_assets/img/ss-run-modal.png').default} />
</figure>
