...
For more detailed instructions, please see the [Building for iOS](../../developing/ios.mdx) or [Building for Android](../../developing/android.mdx) documentation.

If you'd like to follow along with a beginners tutorial that includes utilizing the Camera Cordova plugin, please see our [Build your First App guide](../../angular/your-first-app.mdx). While this guide isn't specific to Studio, you can still follow along using Studio.
