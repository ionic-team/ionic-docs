...
:::note
Check the docs for [Ionic Animations](../utilities/animations.mdx#browser-support) and [Ionic Gestures](../utilities/gestures.mdx#browser-support) for specific browser support related to those utilities.
:::
