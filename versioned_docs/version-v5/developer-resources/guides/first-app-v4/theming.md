...
![Table detailing properties for customizing the primary color in Ionic including base, contrast, shade, and tint.](/img/guides/first-app-v4/theming-properties.png "Ionic Color Customization Properties")
...
![Screenshots comparing the native look of an Ionic app on iOS and Android platforms.](/img/guides/first-app-v3/ion-lab-comparison.png "Ionic Platform Style Comparison")
