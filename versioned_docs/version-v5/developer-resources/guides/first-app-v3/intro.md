...
![Screenshot showing the Ionic app's transformation from a blank 'Tab Two' page to a 'Photo Gallery' with images.](/img/guides/first-app-v3/gallery-combined.png "Ionic App Before and After Photo Gallery")
