...
import Props from '@ionic-internal/component-api/v5/text/props.mdx';
import Events from '@ionic-internal/component-api/v5/text/events.mdx';
import Methods from '@ionic-internal/component-api/v5/text/methods.mdx';
import Parts from '@ionic-internal/component-api/v5/text/parts.mdx';
import CustomProps from '@ionic-internal/component-api/v5/text/custom-props.mdx';
import Slots from '@ionic-internal/component-api/v5/text/slots.mdx';
