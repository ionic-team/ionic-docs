...
<table className="reference-table">
  ...
  <span class="option-spec"> =&lt;name&gt;</span>
      ...
      <thead>
        <tr>
          <th colSpan="2">
            <h3><a href="#option-channel" id="option-channel">
  --channel
  <span class="option-spec"> =&lt;name&gt;</span>
</a></h3>
          </th>
      ...
      <tbody>
              ...
              <tr>
                <th>Description</th>
                <td><p>The channel you want to auto deploy the build to. This can be repeated multiple times if multiple channels need to be specified.</p>
</td>
              </tr>
