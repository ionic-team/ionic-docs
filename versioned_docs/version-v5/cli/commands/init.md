...
<table className="reference-table">
      ...
      <tbody>
              ...
              <tr>
                <th>Description</th>
                <td><p>The name of your project (e.g. <code>myApp</code>, <code>"My App"</code>)</p>
</td>
              </tr>
...
<table className="reference-table">
  ...
  <span class="option-spec"> =&lt;type&gt;</span>
      ...
      <tbody>
              ...
              <tr>
                <th>Description</th>
                <td><p>Type of project (e.g. <code>angular</code>, <code>react</code>, <code>vue</code>, <code>custom</code>)</p>
</td>
              </tr>
      ...
      <thead>
        <tr>
          <th colSpan="2">
            <h3><a href="#option-force" id="option-force">
  --force
      ...
      <tbody>
              ...
              <tr>
                <th>Description</th>
                <td><p>Initialize even if a project already exists</p>
</td>
              </tr>
      ...
      <thead>
        <tr>
          <th colSpan="2">
            <h3><a href="#option-multi-app" id="option-multi-app">
  --multi-app
      ...
      <tbody>
              ...
              <tr>
                <th>Description</th>
                <td><p>Initialize a multi-app project</p>
</td>
              </tr>
...
<table className="reference-table">
  ...
  <span class="option-spec"> =&lt;slug&gt;</span>
      ...
      <tbody>
              ...
              <tr>
                <th>Description</th>
                <td><div><p>Specify a slug for your app</p>
</div></td>
              </tr>
      ...
      <thead>
        <tr>
          <th colSpan="2">
            <h3><a href="#option-default" id="option-default">
  --default
      ...
      <tbody>
              ...
              <tr>
                <th>Description</th>
                <td><div><p>Mark the initialized app as the default project</p>
</div></td>
              </tr>
