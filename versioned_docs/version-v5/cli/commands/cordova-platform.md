...
<table className="reference-table">
      ...
      <tbody>
              ...
              <tr>
                <th>Description</th>
                <td><p><code>add</code>, <code>remove</code>, or <code>update</code> a platform; <code>ls</code>, <code>check</code>, or <code>save</code> all project platforms</p>
</td>
              </tr>
      ...
      <tbody>
              ...
              <tr>
                <th>Description</th>
                <td><p>The platform that you would like to add (<code>android</code>, <code>ios</code>)</p>
</td>
              </tr>
...
<table className="reference-table">
      ...
      <thead>
        <tr>
          <th colSpan="2">
            <h3><a href="#option-resources" id="option-resources">
  --no-resources
      ...
      <tbody>
              ...
              <tr>
                <th>Description</th>
                <td><p>Do not pregenerate icons and splash screen resources (corresponds to <code>add</code>)</p>
</td>
              </tr>
