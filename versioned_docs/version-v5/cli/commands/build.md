...
<table className="reference-table">
  ...
  --watch
      ...
      <thead>
        <tr>
          <th colSpan="2">
            <h3><a href="#option-engine" id="option-engine">
  --engine
  <span class="option-spec"> =&lt;engine&gt;</span>
      ...
      <tbody>
              ...
              <tr>
                <th>Description</th>
                <td><div><p>Target engine (e.g. <code>browser</code>, <code>cordova</code>)</p>
</div></td>
              </tr>
      ...
      <thead>
        <tr>
          <th colSpan="2">
            <h3><a href="#option-platform" id="option-platform">
  --platform
  <span class="option-spec"> =&lt;platform&gt;</span>
      ...
      <tbody>
              ...
              <tr>
                <th>Description</th>
                <td><div><p>Target platform on chosen engine (e.g. <code>ios</code>, <code>android</code>)</p>
</div></td>
              </tr>
