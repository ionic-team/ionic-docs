...
<table className="reference-table">
      ...
      <tbody>
              ...
              <tr>
                <th>Description</th>
                <td><p>The integration to enable (e.g. <code>capacitor</code>, <code>cordova</code>, <code>enterprise</code>)</p>
</td>
              </tr>
...
<table className="reference-table">
      ...
      <thead>
        <tr>
          <th colSpan="2">
            <h3><a href="#option-add" id="option-add">
  --add
      ...
      <tbody>
              ...
              <tr>
                <th>Description</th>
                <td><p>Download and add the integration even if enabled</p>
</td>
              </tr>
  ...
  <span class="option-spec"> =&lt;path&gt;</span>
      ...
      <tbody>
              ...
              <tr>
                <th>Description</th>
                <td><p>Specify an alternative destination to download into when adding</p>
</td>
              </tr>
      ...
      <thead>
        <tr>
          <th colSpan="2">
            <h3><a href="#option-quiet" id="option-quiet">
  --quiet
      ...
      <tbody>
              ...
              <tr>
                <th>Description</th>
                <td><p>Less verbose output, ignore integration errors</p>
</td>
              </tr>
