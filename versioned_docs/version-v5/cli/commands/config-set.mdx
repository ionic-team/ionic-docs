...
<table className="reference-table">
      ...
      <tbody>
              ...
              <tr>
                <th>Description</th>
                <td><p>The property name you wish to set</p>
</td>
              </tr>
      ...
      <tbody>
              ...
              <tr>
                <th>Description</th>
                <td><p>The new value of the given property</p>
</td>
              </tr>
...
<table className="reference-table">
  ...
  --json
      ...
      <tbody>
              ...
              <tr>
                <th>Description</th>
                <td><div><p>Always interpret <code>value</code> as JSON</p>
</div></td>
              </tr>
  ...
  --force
      ...
      <tbody>
              ...
              <tr>
                <th>Description</th>
                <td><div><p>Always overwrite existing values</p>
</div></td>
              </tr>
