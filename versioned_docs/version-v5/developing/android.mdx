...
![Android Studio SDK Setup](./_assets/img/android-studio-sdk-setup.png)
...
<img alt="Android Studio SDK Manager" src={require('./_assets/img/android-studio-sdk.png').default} />
...
![AVD Setup](./_assets/img/android-studio-avd-setup.png)
...
<figure class="device">
  <img alt="Android Emulator Booting" src={require('./_assets/img/android-emulator-booting.png').default} />
</figure>
...
![Android Studio Run Button Area](./_assets/img/android-studio-run-button-area.png)
...
![Android Chrome DevTools](./_assets/img/android-chrome-devtools.png)
...
![Android Studio Logcat](./_assets/img/android-studio-logcat.png)
