...
![Xcode project settings displaying the Signing & Capabilities tab for an iOS app.](/img/guides/first-app-cap-ng/xcode-signing.png "Xcode Signing & Capabilities")
...
![Xcode interface highlighting the Build button to compile an iOS app.](/img/guides/first-app-cap-ng/xcode-build-button.png "Xcode Build Button")
...
![iOS permission prompt for camera access and a photo taken with the camera displayed in the app.](/img/guides/first-app-cap-ng/ios-permissions-photo.png "iOS Permissions and Photo Capture")
...
![Android Studio screenshot showing the AndroidManifest.xml file with camera permissions.](/img/guides/first-app-cap-ng/android-manifest.png "Android Manifest Configuration")
...
![Android Studio interface with the Run button and a connected device selected.](/img/guides/first-app-cap-ng/android-device.png "Android Studio Run Configuration")
...
![Android permission prompt for camera access and a photo taken with the camera displayed in the app.](/img/guides/first-app-cap-ng/android-permissions-photo.png "Android Permissions and Photo Capture")
