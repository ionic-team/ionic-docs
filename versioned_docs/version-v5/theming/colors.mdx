...
:::note
Not sure how to get the variation colors from the base color? Try out our [Color Generator](color-generator) that calculates all of the variations and provides code to copy/paste into an app!
:::

See the [CSS Variables documentation](css-variables) for more information on CSS variables.
...
See the [CSS Variables documentation](css-variables) for more information on setting and using CSS variables.
