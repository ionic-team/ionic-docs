...
![Close-up of the Xcode toolbar with the Build button highlighted, indicating where to click to build an iOS app.](/img/guides/first-app-cap-ng/xcode-build-button.png "Xcode Build Button")
...
![iOS permission prompt requesting camera access and the resulting photo taken with the camera displayed in the app.](/img/guides/first-app-cap-ng/ios-permissions-photo.png "iOS Camera Permission Prompt and Photo Result")
...
![Android Studio editor showing the AndroidManifest.xml file with camera permissions highlighted.](/img/guides/first-app-cap-ng/android-manifest.png "Android Manifest Permissions")
...
![Android Studio interface with the Run button highlighted and a connected device selected for app deployment.](/img/guides/first-app-cap-ng/android-device.png "Android Studio Run Configuration")
...
![Android permission prompt requesting camera access and the resulting photo taken with the camera displayed in the app.](/img/guides/first-app-cap-ng/android-permissions-photo.png "Android Camera Permission Prompt and Photo Result")
