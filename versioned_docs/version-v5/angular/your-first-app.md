...
![Animated GIF showing the Ionic Photo Gallery app's user interface with live code editing and preview.](/img/guides/first-app-cap-ng/email-photogallery.gif "Ionic Photo Gallery App Demonstration")
