...
Navigating can also be performed programmatically using `document.querySelector('ion-router').push('/new')`. Refer to the [Ionic Router documentation](/api/router.mdx) for more information.
