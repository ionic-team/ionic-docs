...
## Generating a release build {/* #generating-a-release-build */}
...
## Generating Signing Certs {/* #generating-signing-certs */}
...
## Signing the App in Xcode {/* #signing-the-app-in-xcode */}
