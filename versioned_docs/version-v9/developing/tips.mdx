...
## Resolving Permission Errors {/* #resolving-permission-errors */}
...
## Using the iOS Simulator {/* #using-the-ios-simulator */}
...
## Using the Genymotion Android Emulator {/* #using-the-genymotion-android-emulator */}
