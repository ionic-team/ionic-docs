...
### Hardware Back Button in a Browser or a PWA {/* #hardware-back-button-in-a-browser-or-a-pwa */}
...
## Calling Multiple Handlers {/* #calling-multiple-handlers */}
...
## Handlers with the Same Priorities {/* #handlers-with-the-same-priorities */}
